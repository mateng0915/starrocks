...
if [ ${BUILD_BE} -eq 1 ]; then
    ...
    cp -r -p ${STARROCKS_THIRDPARTY}/installed/hadoop-3.3.sdi-058/share/hadoop/common ${STARROCKS_OUTPUT}/be/lib/hadoop/
    cp -r -p ${STARROCKS_THIRDPARTY}/installed/hadoop-3.3.sdi-058/share/hadoop/hdfs ${STARROCKS_OUTPUT}/be/lib/hadoop/
   cp -p ${STARROCKS_THIRDPARTY}/installed/hadoop-3.3.sdi-058/share/hadoop/tools/lib/hadoop-azure-* ${STARROCKS_OUTPUT}/be/lib/hadoop/hdfs
    cp -p ${STARROCKS_THIRDPARTY}/installed/hadoop-3.3.sdi-058/share/hadoop/tools/lib/azure-* ${STARROCKS_OUTPUT}/be/lib/hadoop/hdfs
    cp -p ${STARROCKS_THIRDPARTY}/installed/gcs_connector/*.jar ${STARROCKS_OUTPUT}/be/lib/hadoop/hdfs
    cp -r -p ${STARROCKS_THIRDPARTY}/installed/hadoop-3.3.sdi-058/lib/native ${STARROCKS_OUTPUT}/be/lib/hadoop/
